using Actividades.Components;
using Actividades.Modelo;
using Actividades.Repositorio;
...
builder.Services.AddScoped<IRepositorioClasificacion, RepositorioClasificacion>();
builder.Services.AddScoped<IRepositorioMateriales, RepositorioMateriale>();
